...
import { INQUIRY_CATEGORIES, submitInquiry, getMyInquiries } from '../lib/supabase';
  ...
  if (!isLoggedIn) {
    return (
      <div
        ...
        style={{ paddingTop: 160, textAlign: 'center', minHeight: '60vh' }}
      >
      ...
      <div className="section" style={{ maxWidth: 760, margin: '0 auto' }}>
        <div style={{ marginBottom: 36 }}>
          ...
          <p style={{ fontSize: 13, color: 'var(--muted)', lineHeight: 1.8 }}>
            이용 중 어려운 점이나 궁금한 것을 남겨주세요. 분류를 골라주시면 담당자가 더 빨리 확인할
            수 있습니다.
          </p>
        </div>
        ...
        >
            ...
            {INQUIRY_CATEGORIES.map((c) => (
              ...
              >
                <div
                  style={{
                    fontSize: 13,
                    color: category === c.value ? 'var(--gold)' : 'var(--text)',
                    fontFamily: 'var(--font-serif)',
                    marginBottom: 3,
                  }}
                >
          ...
          <textarea
            ...
            maxLength={5000}
            placeholder={
              '어떤 화면에서 무엇을 하려다 막히셨는지 적어주시면 가장 빠릅니다.\n오류라면 사용하신 기기와 브라우저도 알려주세요.'
            }
            style={{
              width: '100%',
              background: 'var(--bg)',
