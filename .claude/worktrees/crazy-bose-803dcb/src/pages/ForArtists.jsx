...
const ForArtists = ({ onAuthOpen }) => {
  ...
  const seoDescs = {
    ko: 'Phosnap 작가 커뮤니티에 참여하여 수익을 창출하고 클라이언트와 직접 연결되세요. 작가 수수료 10~15% (월 거래량 기반), 투명한 정산 시스템.',
    en: 'Join Phosnap photographer community. Earn money, connect with clients directly. Artist commission 10–15% (volume-based), transparent settlement.',
    ja: 'Phosnap 写真家コミュニティに参加。直接クライアントと繋がり、収入を増やしましょう。作家手数料10〜15%（月間取引量ベース）、透明な精算システム。',
    zh: '加入Phosnap摄影师社区。直接与客户联系，增加收入。摄影师佣金10~15%（按月成单量），透明清晰的结算系统。',
  };
    ...
    <div className="page-enter" style={{ paddingTop: 100 }}>
      ...
      <div className="stats-bar" style={{ maxWidth: 1200, margin: '0 auto' }}>
        {[
          ...
          { num: '10~15%', labelKey: 'forartists.statFee' },
