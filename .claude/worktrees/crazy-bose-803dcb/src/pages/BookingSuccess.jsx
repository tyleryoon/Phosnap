    ...
    const save = async () => {
      ...
      try {
        const result = await confirmPayment({
          ...
          subtotal:               subtotalParam   ? Number(subtotalParam)   : undefined,
          serviceFee:             serviceFeeParam ? Number(serviceFeeParam) : undefined,
      ...
      const { error } = await createBooking({
        ...
        service_fee:            serviceFeeParam ? Number(serviceFeeParam) : 0,
        ...
        <div style={{ border: '1px solid var(--gold-border)', padding: '40px 36px', background: 'var(--gold-dim)', position: 'relative', marginBottom: 24 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
            {[
              ...
              { label: c.subtotal,   value: subtotalParam ? `₩${fmt(subtotalParam)}` : '' },
              { label: c.serviceFee, value: serviceFeeParam ? `₩${fmt(serviceFeeParam)} (4%)` : '' },
