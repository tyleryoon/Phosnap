                  ...
                  <div style={{ marginTop: 20, borderTop: '1px solid var(--border)', paddingTop: 16 }}>
                    ...
                    <div style={{ fontSize: 12, color: 'rgba(242,242,242,0.6)', lineHeight: 1.8, padding: '12px 16px', background: 'rgba(0,0,0,0.2)', border: '1px solid var(--border)' }}>
                      <div style={{ marginBottom: 6 }}>
                        <span style={{ color: 'var(--gold)', fontFamily: 'var(--font-serif)' }}>작가 수수료 (월 거래 건수 기반)</span>
                      </div>
                      <div style={{ marginBottom: 4 }}>
                        <span style={{ color: 'var(--muted)' }}>· 기본:</span> 15% &nbsp;|&nbsp;
                        <span style={{ color: '#9aa3b0' }}>· 실버 (월 5건+):</span> 13%
                      </div>
                      <div style={{ marginBottom: 8 }}>
                        <span style={{ color: 'var(--gold)' }}>· 골드 (월 15건+):</span> 11% &nbsp;|&nbsp;
                        <span style={{ color: '#c084fc' }}>· 플래티넘 (월 30건+):</span> 10%
                      </div>
                      <div style={{ marginBottom: 6, fontSize: 11, color: 'var(--muted)' }}>
                        ※ 수수료는 패키지 금액에서만 차감되며, 고객은 별도로 4% 서비스 수수료를 부담합니다 (작가 정산 무관).
                      </div>
