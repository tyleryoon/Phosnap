...
// 기준: 누적 완료 건수 + 평균 평점
// ※ 실제 수수료는 commission.js의 월 거래량 기반 ARTIST_TIERS(기본 15% / 실버 13% / 골드 11% / 플래티넘 10%)로 산정된다.
//   여기 등급은 노출/뱃지/콜라보 제한 등 평판 보상에만 사용된다.
export const ARTIST_TIERS = {
  rising:      { ko: 'Rising',      en: 'Rising',      icon: '✦',    stars: '✦',       minShoots: 0,   minRating: 0,   benefits: '기본 프로필 노출, 예약 수신' },
  established: { ko: 'Established', en: 'Established', icon: '✦✦',   stars: '✦✦',      minShoots: 30,  minRating: 4.0, benefits: '검색 우선 노출, 뱃지 표시, 콜라보 제의 +2회/월' },
  premier:     { ko: 'Premier',     en: 'Premier',     icon: '✦✦✦',  stars: '✦✦✦',     minShoots: 100, minRating: 4.5, benefits: '홈 추천 등록, 즉시예약 활성화' },
  elite:       { ko: 'Elite',       en: 'Elite',       icon: '✦✦✦✦', stars: '✦✦✦✦',    minShoots: 300, minRating: 4.7, benefits: '최우선 노출, 전용 매니저 배정' },
};
...
// 작가의 평판 등급 조회 (실제 수수료가 아닌 노출/뱃지 등급)
// 결제 수수료는 commission.js 의 calculateArtistPayout()를 사용한다.
